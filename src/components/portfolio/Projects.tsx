            ...
            >
              <div className="aspect-video relative overflow-hidden bg-gradient-to-br from-primary/20 to-accent/20">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = `https://via.placeholder.com/400x300/6366f1/ffffff?text=${project.title}`;
                  }}
                />
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 group-hover:text-primary dark:group-hover:text-primary-dark transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 text-xs font-medium bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-dark rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex items-center space-x-3">
                  {project.liveUrl && (
                    <a
                      ...
                      className="flex items-center space-x-1 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary-dark transition-colors"
                    >
