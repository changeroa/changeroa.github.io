  ...
  return (
    ...
    >
      <article className="h-full glass-effect rounded-2xl overflow-hidden hover-lift">
        ...
        <div className="p-6">
          {post.featured && (
            <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-accent/10 text-accent rounded-full mb-3">
              Featured
            </span>
          )}
          
          <h3 className="text-xl font-semibold mb-2 group-hover:text-primary dark:group-hover:text-primary-dark transition-colors line-clamp-2">
            {post.title}
          </h3>
